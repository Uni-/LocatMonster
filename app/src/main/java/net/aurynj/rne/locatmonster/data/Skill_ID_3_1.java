...
public class Skill_ID_3_1 extends SkillClass {
    public Skill_ID_3_1() {
        super();
    }
    ...
    private class SkillEffect_ID_3_1_1 extends SkillEffectClass {
        @Override
        public float getSuccessProbability(CharacterStatus near, CharacterStatus far) {
            return 1;
        }
    ...
    private class SkillEffect_ID_3_1_2 extends SkillEffectClass {
        @Override
        public float getSuccessProbability(CharacterStatus near, CharacterStatus far) {
            return 1;
        }
