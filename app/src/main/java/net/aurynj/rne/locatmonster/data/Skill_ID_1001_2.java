...
public final class Skill_ID_1001_2 extends SkillClass {
    public Skill_ID_1001_2() {
        super();
    }
    ...
    public SkillEffectClass[] getEffects() {
        final SkillEffectClass[] skillEffects = { new SkillEffect_ID_1001_2_1(), new SkillEffect_ID_1001_2_2() };
        return skillEffects;
    }

    @Override
    public VisualEffectClass[] getVisualEffects(boolean success) {
        final VisualEffectClass[] skillVisualEffectClassesOnSuccess = { new Skill_ID_1001_2_Visual_1() };
        if (success)
    ...
    private final class SkillEffect_ID_1001_2_1 extends SkillEffectClass {
        @Override
        public float getSuccessProbability(CharacterStatus near, CharacterStatus far) {
            return 1;
        }
    ...
    private final class SkillEffect_ID_1001_2_2 extends SkillEffectClass {
        @Override
        public float getSuccessProbability(CharacterStatus near, CharacterStatus far) {
            return 1;
        }
    ...
    private final class Skill_ID_1001_2_Visual_1 extends VisualEffectClass {
        @Override
        public Type getType() {
            return Type.NONE;
        }
