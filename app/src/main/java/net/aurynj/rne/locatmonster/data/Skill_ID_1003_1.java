...
public final class Skill_ID_1003_1 extends SkillClass {
    ...
    public VisualEffectClass[] getVisualEffects(boolean success) {
        final VisualEffectClass[] skillVisualEffectClassesOnSuccess = { new Skill_ID_1003_1_Visual_1() };
        if (success)
    ...
    private final class SkillEffect_ID_1003_1_1 extends SkillEffectClass {
        @Override
        public float getSuccessProbability(CharacterStatus near, CharacterStatus far) {
            return 1;
        }
    ...
    private final class SkillEffect_ID_1003_1_2 extends SkillEffectClass {
        @Override
        public float getSuccessProbability(CharacterStatus near, CharacterStatus far) {
            return 1;
        }
    ...
    private final class Skill_ID_1003_1_Visual_1 extends VisualEffectClass {
        @Override
        public Type getType() {
            return Type.NONE;
        }
